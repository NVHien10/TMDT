...
const Topp100 = () => {
  return (
    <div className="mt-[48px] h-fit w-fit mdd:mt-[68px] mdd:h-[1048px] mdd:w-[991px] lgg:mt-[68px] lgg:h-[548px] lgg:w-[1440px]">
      ...
      <div className="Phan2 mx-[20px] mt-[24px] flex h-fit items-center w-[438px] overflow-x-scroll mdd:mx-[90px] mdd:mt-[48px] mdd:grid mdd:h-[980px] mdd:w-[811px] mdd:grid-cols-2 lgg:mx-[90px] lgg:mt-[48px] lgg:grid lgg:h-[480px] lgg:w-[1260px] lgg:grid-cols-4">
        {Top100.map((data) => (
          <div
            key={data.id}
